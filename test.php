    ...
    foreach ($activities as $activity) {
        if ($activity['type'] == "quiz") {
            ...
            $query = "SELECT 
                    ...
                    FROM m_quiz_slots slot
                    LEFT JOIN m_question_references qr ON qr.component = 'mod_quiz'
                    AND qr.questionarea = 'slot' AND qr.itemid = slot.id
                    LEFT JOIN m_question_bank_entries qbe ON qbe.id = qr.questionbankentryid
                    LEFT JOIN m_question_versions qv ON qv.questionbankentryid = qbe.id
                    LEFT JOIN m_question q ON q.id = qv.questionid
