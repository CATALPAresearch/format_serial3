...
(function (global, factory) {
    console.log('TT   ',typeof exports, typeof define, define.amd );
    require.config({ enforceDefine: false, paths: { "d3": [M.cfg.wwwroot + "/course/format/ladtopics/lib/build/d3.v4.min"] } });
...
}(this, (function (exports, d3TimeFormat, d3Time, d3Format, d3Selection, d3Dispatch, d3Array, d3Scale, d3Interpolate, d3Collection, d3ScaleChromatic, d3Axis, d3Zoom, d3Brush, d3Timer, d3Shape, d3Geo, d3Ease, d3Hierarchy) {
    'use strict';
