...
/**
 * This file contains main class for serial3 course format.
 *
 * @since     Moodle 2.0
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_serial3 extends core_courseformat\base {
    ...
    public function uses_indentation(): bool {
        return (get_config('format_serial3', 'indentation')) ? true : false;
    }
    ...
    /**
     * Returns the default section name for the serial3 course format.
     *
    ...
    public function get_default_section_name($section) {
        ...
        return get_string('newsection', 'format_serial3');
    }
     ...
     * TODO
     *
        * DONE usenetlink: MenuBar.vue usernet url => textfield
        * DONE hiddenmodules: main.js hide modules from course page => ?
        * ProgressChartAdaptive:
        *  - mapActivityNames, 
        *  - includedActivities => checkboxes
        * DONE excludesections: store/overview: excluded_sections, allowedActivitities => textarea comma separated
     *
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($foreditform && !isset($courseformatoptions['coursedisplay']['label'])) {
            $courseformatoptionsedit = [
                ...
                'excludesections' => [
                    'label' => new lang_string('excludesections', 'format_serial3'),
                    'help' => 'excludesections',
                    'help_component' => 'format_serial3',
                    'element_type' => 'textarea',
                ],
                'hiddenmodules' => [
                    'label' => new lang_string('hiddenmodules', 'format_serial3'),
                    'help' => 'hiddenmodules',
                    'help_component' => 'format_serial3',
                    'element_type' => 'textarea',
                ],
     ...
     * @return bool whether there were any changes to the options values.
     */
    public function update_course_format_options22222($data, $oldcourse = null) {
        global $DB; // MDL-37976.
    ...
    public function get_config_for_external() {
        ...
        $formatoptions['indentation'] = get_config('format_serial3', 'indentation');
