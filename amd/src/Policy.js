...
define([
    ...
    M.cfg.wwwroot + "/course/format/ladtopics/lib/build/moment-with-locales.min"
    ...
    function ($, Vue, moment) {
        ...
        require.config({
            enforceDefine: false,
            paths: {
                "moment226": [M.cfg.wwwroot + "/course/format/ladtopics/lib/build/moment-with-locales.min"],
            },
            shim: {
                "moment226": {
                    exports: 'moment'
